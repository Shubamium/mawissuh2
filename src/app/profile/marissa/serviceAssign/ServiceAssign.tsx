  ...
  return (
    <>
      <div className="assign-edge" id="service">
        <img
          src="/decors/assign-edge.png"
          alt=""
          className="decor-assign-edge t"
        />
      </div>
        ...
        <div className="confine">
          <div className="service-nav">
            <button
              ...
              className={`btn btn-service shiny ${
                activeMenu === -1 ? "active" : ""
              }`}
            >
              MAIN SERVICE
          ...
          <AnimatePresence mode="wait">
            {activeMenu === -1 ? (
              ...
              <OtherService
                categoryId={otherService[activeMenu].title}
                list={otherService[activeMenu].services}
              />
            )}
          </AnimatePresence>
        </div>
