      ...
      <MouseMoveScale className="confine">
        <div className="detail-tab">
          <div className="detail-panel">
            <div className="profile">
              <div className="image glow-filter">
                <img
                  src={urlFor(talentData.data.profile).url()}
                  alt=""
                  className="pfp"
                />
              </div>
            ...
            <div className="entry-status">
              ...
              <div className="status bottom">
                ...
                {talentData.data.status === "active" ? (
                  <p>
                    {durationjs.days()}d {durationjs.hours()}h{" "}
                    {durationjs.minutes()}m
                  </p>
                ) : (
            ...
            <div className="entry-contact">
              {talentData.data?.socials?.length === 0 ? (
                <h2>UNAVAILABLE CONTACT</h2>
              ) : null}
          ...
          <Link href={"/talent"} className="btn btn-back glow-filter">
            ...
            >
              <path
                d="M30.9688 19H6.96875L18.4688 2"
                stroke="black"
                strokeWidth="7"
              />
            </svg>
        ...
        <div className="briefing-tab">
          <div className="briefing">
            <div className="decor_diamond"></div>
            <div className="briefing-panel">
              ...
              <div className="description">
                {talentData.data.briefing === undefined ||
